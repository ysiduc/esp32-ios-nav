...
#ifndef GOOGLE_PROTOBUF_INCLUDED_transit_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_transit_2eproto_2epb_2eh
...
class Transit_StopPair final :
    public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:valhalla.mjolnir.Transit.StopPair) */ {
 public:
  ...
  inline Transit_StopPair(const Transit_StopPair& from)
      : Transit_StopPair(nullptr, from) {}
  ...
  Transit_StopPair* New(::google::protobuf::Arena* arena = nullptr) const final {
...
class Transit_Shape final :
    public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:valhalla.mjolnir.Transit.Shape) */ {
 public:
  ...
  inline Transit_Shape(const Transit_Shape& from)
      : Transit_Shape(nullptr, from) {}
  ...
  Transit_Shape* New(::google::protobuf::Arena* arena = nullptr) const final {
...
class Transit_Route final :
    public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:valhalla.mjolnir.Transit.Route) */ {
 public:
  ...
  inline Transit_Route(const Transit_Route& from)
      : Transit_Route(nullptr, from) {}
  ...
  Transit_Route* New(::google::protobuf::Arena* arena = nullptr) const final {
...
class Transit_Node final :
    public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:valhalla.mjolnir.Transit.Node) */ {
 public:
  ...
  inline Transit_Node(const Transit_Node& from)
      : Transit_Node(nullptr, from) {}
  ...
  Transit_Node* New(::google::protobuf::Arena* arena = nullptr) const final {
...
class Transit final :
    public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:valhalla.mjolnir.Transit) */ {
 public:
...
inline const ::google::protobuf::RepeatedField<::uint32_t>& Transit_StopPair::_internal_service_added_dates()
    const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
...
inline const ::google::protobuf::RepeatedField<bool>& Transit_StopPair::_internal_service_days_of_week()
    const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
...
inline const ::google::protobuf::RepeatedField<::uint32_t>& Transit_StopPair::_internal_service_except_dates()
    const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_transit_2eproto_2epb_2eh
