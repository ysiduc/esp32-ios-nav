...
constexpr DirectionsLeg_Maneuver_Type DirectionsLeg_Maneuver_Type_Type_MAX = static_cast<DirectionsLeg_Maneuver_Type>(44);
constexpr int DirectionsLeg_Maneuver_Type_Type_ARRAYSIZE = 44 + 1;
...
class DirectionsLeg_Maneuver final :
 ...
 public:
  ...
  static constexpr Type kLevelChange = DirectionsLeg_Maneuver_Type_kLevelChange;
  static inline bool Type_IsValid(int value) {
