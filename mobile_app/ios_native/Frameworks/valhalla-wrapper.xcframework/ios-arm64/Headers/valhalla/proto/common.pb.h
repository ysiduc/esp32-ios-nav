...
class LevelChange final :
    public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:valhalla.LevelChange) */ {
 public:
  ...
  inline LevelChange(const LevelChange& from)
      : LevelChange(nullptr, from) {}
  ...
  LevelChange* New(::google::protobuf::Arena* arena = nullptr) const final {
