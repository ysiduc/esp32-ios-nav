...
final class RerouteManagerTests: XCTestCase {
    ...
    override func setUp() {
        ...
        let stepA = NavStep(coordinate: coordsA[1], distanceMeters: 556.0, durationSeconds: 60.0, streetName: "A", maneuverType: .arrive, instruction: "Arrive")
        initialRoute = NavRoute(coordinates: coordsA, steps: [stepA], totalDistanceMeters: 556.0, totalDurationSeconds: 60.0)
        ...
        let stepB = NavStep(coordinate: coordsB[1], distanceMeters: 500.0, durationSeconds: 50.0, streetName: "B", maneuverType: .arrive, instruction: "Arrive")
        replacementRoute = NavRoute(coordinates: coordsB, steps: [stepB], totalDistanceMeters: 500.0, totalDurationSeconds: 50.0)
